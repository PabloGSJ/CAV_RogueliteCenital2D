...
public class SqueletonShot : MonoBehaviour
{
    ...
    //Sprites
    public Sprite squeleton_shot0;
    public Sprite squeleton_shot1;
    public Sprite squeleton_shot2;
    public Sprite currentSprite;

    public void Start()
    {
        currentSprite = squeleton_shot0;
    ...
    public void Update()
    {
        ...
        if (rc.CurrentRoom == enemyRoom)
        {
            ...
            if (currentSprite == squeleton_shot0 && timer <= cd / 4)
            {
                currentSprite = squeleton_shot1;
                spriteTimer = Time.time;
                this.GetComponent<SpriteRenderer>().sprite = currentSprite;
            }
            else if (currentSprite == squeleton_shot2)
            {
